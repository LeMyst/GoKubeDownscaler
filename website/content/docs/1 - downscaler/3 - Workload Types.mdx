...
- id: downscalepolicies
- resource: downscalepolicy.v1.downscaler.io

Scales by updating the status phase field to indicate current scaling state.
This is a custom resource specifically designed to manage downscaling policies with built-in support for downtime and uptime parameters.
